          ...
          <div style={{'width':'70%', 'height':'auto'}}   className='container mt-3 bg-light rounded  shadow'>
              <div className='signup-content row '>
                  <div className='signup-form col-6 ms-3 mb-5'>
                        ...
                        <div className="form-group mb-1">
                          ...
                          <div className="form-group mb-1">
                            ...
                            <input type="password" name="cpassword" id='cpassword' className="form-control border-none" autoComplete='off' value={user.cpassword} onChange={handleInput} placeholder="Confirm password"/>
                  ...
                  <div className=" col-md-5 mt-5 ms-5 mb-5" style={{'maxWidth':'100%', 'height':'auto'}}>
                    <img  alt="" className='ms-5 mt-5 mb-4' style={{'maxWidth':'100%', 'height':'auto'}} />
                    <br />
